...
- caller evidence independently verified by staging plane: no
- proposed source reads/module loads/child processes: 0/0/0
- admission selections/authorizations/promotions: 0/0/0
- admission adversarial holds: 15
...
- a non-executing admission/staging plane that receipts proposed entries and a hypothetical registry digest while retaining human review, explicit source change, regression, manifest, and authorization as unresolved gates.
